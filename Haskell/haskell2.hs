...
sumatoriaDesde6 = foldr desglosaSumaP "0" [1,2,3,4,5,6]
...
sumatoriaAux suma numero = suma + numero
sumatoria = foldl sumatoriaAux 0 [1,2,3,4,5]
sumatoriaP lista = foldl sumatoriaAux 0 lista
