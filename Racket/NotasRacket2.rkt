...
(define (qs li)
  (if (empty? li)
      null
      (let* ([pivot (car li)]
             [lt (filter (lambda (x) (< x pivot)) (cdr li))]
             [gt (filter (lambda (x) (> x pivot)) (cdr li))])
...
*Ejemplo que NO tiene recursividad termianl 
...
;(mapa (lambda (x) (* x x)) '(9 3 4 5 10)) PRUEBA
...
(define (set-n x i li)
  (cond [(empty? li) (error "WUT")]
        ...
        ;PRUEBA: (set-n 5 3 '(1 2 3 4 5 6 7 8))
...
(define (iio x li)
  (if (empty? li)
      ...
      (if (<= x (car li))
          ...
          ;PRUEBA(iio 5 '(1 2 3 4 6 7 8 9 10))
...
(define (sum-ren r1 r2)
  (if (empty? r1)
      null
      (cons (+ (car r1) (car r2)) (sum-ren (cdr r1) (cdr r2)))))

      ;PRUEBA: (sum-ren '(1 2 3) '(4 5 6))
...
(define (summ m1 m2)
  (if (empty? m1)
      null
      (cons (sum-ren (car m1) (car m2)) (summ (cdr m1) (cdr m2)))))


      ;(summ (list (list 1 2 3) (list 4 5 6)) (list (list 7 8 9) (list 10 11 12)))
